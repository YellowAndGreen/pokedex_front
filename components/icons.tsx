...
export const StarIcon: React.FC<{ className?: string; filled?: boolean }> = ({ className = "w-5 h-5", filled = false }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className} fill={filled ? "currentColor" : "none"}>
    {filled ? (
      <path strokeLinecap="round" strokeLinejoin="round" d="M10.788 3.21c.448-1.077 1.976-1.077 2.424 0l2.082 5.007 5.404.433c1.164.093 1.636 1.545.749 2.305l-4.117 3.527 1.257 5.273c.271 1.136-.964 2.033-1.96 1.425L12 18.354l-4.502 2.827c-.996.608-2.231-.29-1.96-1.425l1.257-5.273-4.117-3.527c-.887-.76-.415-2.212.749-2.305l5.404-.433 2.082-5.006z" />
    ) : (
...
export const ImagePlaceholderIcon: React.FC<{ className?: string }> = ({ className = "w-12 h-12 text-gray-400" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
...
export const FlaskIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => ( // Simplified test tube/flask
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104A7.493 7.493 0 004.5 9.75c0 1.35.378 2.622 1.05 3.75m13.95-3.75c0-1.35-.378-2.622-1.05-3.75m-10.95 6.5A7.493 7.493 0 009.75 20.896c2.076 0 3.965-.84 5.303-2.222M12 3v2.25m0 0A3.748 3.748 0 0115.75 9c0 .88-.284 1.69-.778 2.363M12 5.25A3.748 3.748 0 008.25 9c0 .88.284 1.69.778 2.363m2.972-4.113A3.73 3.73 0 0012 7.5c-.94 0-1.804.346-2.474.925m4.948 0A3.73 3.73 0 0112 7.5c.94 0 1.804.346 2.474.925" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 15.75l1.586-1.586a2.25 2.25 0 013.182 0L15 15.75M9 15.75H6.75A2.25 2.25 0 004.5 18v.75c0 .621.504 1.125 1.125 1.125H9M15 15.75h2.25A2.25 2.25 0 0119.5 18v.75c0 .621-.504 1.125-1.125 1.125H15" />
 </svg>
);
...
export const ShareIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.217 10.907a2.25 2.25 0 100 2.186m0-2.186c.5-1.212 1.63-2.08 2.933-2.286m-2.933 2.286c-.079.158-.14.321-.188.487M8.69 12.514c.079.158.14.321.188.487m0 0c.124.486.305.94.527 1.361m1.63-1.983c-.123.486-.305.94-.527-1.361m0 0c-.5 1.212-1.63 2.08-2.933 2.286m2.933-2.286c.079-.158.14-.321-.188-.487M15.31 13.093c-.079-.158-.14-.321-.188-.487m0 0c-.124-.486-.305-.94-.527-1.361m-1.63 1.983c.123-.486.305-.94.527-1.361m0 0c.5-1.212 1.63-2.08 2.933-2.286m-2.933 2.286c-.079.158-.14.321-.188.487M6.75 12.75h10.5M6.75 12.75a2.25 2.25 0 01-2.25-2.25V6.75a2.25 2.25 0 012.25-2.25h10.5a2.25 2.25 0 012.25 2.25v3.75a2.25 2.25 0 01-2.25 2.25M6.75 12.75v3.75a2.25 2.25 0 002.25 2.25h10.5a2.25 2.25 0 002.25-2.25V12.75" />
  </svg>
);
...
export const RectangleStackIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-3.75 2.25M21.75 12l-4.179-2.25M6.429 14.25l5.571 3 5.571-3M4.5 21.75l5.571-3 5.571 3M4.5 12l5.571-3 5.571 3" />
  </svg>
);
